...
export function StructuredData({ data }: StructuredDataProps) {
  ...
  const websiteSchema = {
    ...
    "description": "네이버지도에는 없는 진짜 동네지도 - 전국 맛집, 여행지, 숨은명소, 휴게소 정보 (2025)",
    "inLanguage": "ko-KR",
    "potentialAction": {
      "@type": "SearchAction",
      "target": {
  ...
  const organizationSchema = {
    ...
    "description": "네이버지도에는 없는 진짜 동네지도를 제공하는 로컬 정보 플랫폼 (2025)",
    "foundingDate": "2024",
    "knowsAbout": [
      "맛집 정보",
      "여행지 추천",
  ...
  const imageGallerySchema = {
    ...
    "description": "전국 맛집, 여행지, 숨은명소, 휴게소의 이미지를 모은 갤러리 (2025)",
    "url": "https://localmap.cc",
  ...
  const restaurantCollectionSchema = {
    ...
    "@type": "Collection",
    "name": "전국 맛집 지도",
    "description": "대한민국 전국의 맛집, 여행지, 휴게소 정보를 지역별로 정리한 컬렉션 (2025)",
    "url": "https://localmap.cc",
    "about": [
      {
        "@type": "Place",
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "동네지도",
    "description": "네이버지도에는 없는 진짜 로컬 정보를 제공하는 동네지도 (2025)",
    "url": "https://localmap.cc",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "서울, 부산, 제주, 경주 등 전국 주요 도시의 맛집과 여행 정보를 제공합니다. 전통주, 벚꽃명소, 온천, 휴게소 맛집 등 다양한 카테고리의 2025 최신 정보가 있습니다."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "지역별(서울, 부산, 제주, 경주), 카테고리별(맛집, 전통주, 벚꽃명소, 온천, 휴게소 등)로 분류되어 있어 원하는 정보를 쉽게 찾을 수 있습니다. 2025년 최신 정보를 제공합니다."
        }
      }
    ]
  };
